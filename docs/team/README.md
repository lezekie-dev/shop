...
└── decisions/
    ...
    ├── 0002-payment-provider-interface.md  (amendée S1-002)
    ├── 0003-prix-centimes.md               (amendée S1-002, renommage minor)
    ├── 0004-stock-au-paiement.md           (amendée S1-002)
    ├── 0005-webhooks-idempotents.md
    ├── 0006-cartographie-deps-et-check-constraints.md   (nouvelle S1-002)
    └── 0007-migration-prod-init-container.md            (nouvelle S1-002)
